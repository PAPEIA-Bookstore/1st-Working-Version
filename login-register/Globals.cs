...
namespace login_register
{
    public static partial class GLOBALS
    {
        ...
        public static readonly string cardREGEX = "^\\d{16}$";
        public static readonly string CVVREGEX = "^\\d{3}$";
        public static readonly string expDateREGEX = "^\\d{2}\\/\\d{2}$";
        public static readonly string postalCodeREGEX = "^\\d{5}$";
        public static readonly string cityREGEX = "^[A-Z][a-zA-Z\\s]+$";
